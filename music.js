...
setInterval(() => {
  http.get(`http://c4dis.glitch.me/`); //تعديل مهم حط اسم المشروع
}, 280000);
...
const GUILDID = '435883696797777921'; //  تعديل مهم ايدي السيرفر  
const CHANNELID = '765229163493326898'; // تعديل مهم ايدي الروم الصوتي
...
//تغير الحالة
const developers = ["695353113963397160","","",""] ///تعديل مهم حط هنا ايدي اللي بدك يتحكمو بالحالة
...
const youtube = new YouTube("AIzaSyABjQc1WwHk4gdYJD_NTmUgK_xvrpt_kHM"); //تعديل مهم عدل الاي بي اي بواحد جديد او خليه زي ماهو
